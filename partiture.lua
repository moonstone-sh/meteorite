    ...
    materialize = {
      ...
      collect = {
        ...
        lua_modules = {
          ...
          { name = "meteorite/profile.lua", path = "src/meteorite/profile.lua" },
          { name = "meteorite/patterns.lua", path = "src/meteorite/patterns.lua" },
          { name = "meteorite/lifter.lua", path = "src/meteorite/lifter.lua" },
          { name = "meteorite/json.lua", path = "src/meteorite/json.lua" },
          { name = "meteorite/http_client.lua", path = "src/meteorite/http_client.lua" },
          { name = "meteorite/hybrid.lua", path = "src/meteorite/hybrid.lua" },
