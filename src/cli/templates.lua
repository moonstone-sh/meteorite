...
function handler_sync.partiture_common()
  return table.concat({
    ...
    "  if not p.control then return request.require_behavior(value, \"Meteorite partiture\") end",
    "  local mode = p.control.value(\"meteorite-mode\", value.mode, { source = \"invocation\" })",
    "  local backend = p.control.value(\"meteorite-backend\", value.backend, { source = \"invocation\" })",
    "  p.control.require(\"meteorite-mode-required\", mode:present(), {",
    "    code = \"missing_meteorite_mode\", subject = \"--mode\",",
    "    message = \"Meteorite partiture requires an explicit mode\",",
    "    expected = \"--mode <mode>\", actual = value.mode,",
    ...
    "    code = \"missing_meteorite_backend\", subject = \"--backend\",",
    "    message = \"Meteorite partiture requires an explicit backend\",",
    "    expected = \"--backend <backend>\", actual = value.backend,",
    "    hint = \"Run a generated Moonstone script, or pass --backend after the partiture delimiter.\",",
    "  })",
    "  value.mode = value.mode or \"__missing_mode__\"",
    "  value.backend = value.backend or \"__missing_backend__\"",
    "  return value",
    "end",
    "",
