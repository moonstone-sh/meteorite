...
pub fn build(b: *std.Build) void {
    ...
    const benchmark_instrumentation = b.option(bool, "benchmark-instrumentation", "Enable fixture benchmark counters and metadata") orelse false;
    ...
    const bridge_bench_stats_module = b.createModule(.{
        .root_source_file = b.path(if (benchmark_instrumentation) "zig/bridge/lua_bench_stats.zig" else "zig/bridge/lua_bench_stats_stub.zig"),
        .target = target,
        .optimize = optimize,
    });
